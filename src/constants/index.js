...
export const projects = [
  {
    ...
    image: comicify_ai,
    content:
      "Comprehensive Boat Booking and Management System, Integrated real‑time tracking and notifications for order updates using Socket.IO. Secure and scalable backend built with Node.js, MongoDB, and Firebase. Frontend solutions developed using React, React Native, and Angular, ensuring cross‑platform compatibility and responsive design. Designed a user‑friendly interface using Material UI and CSS to ensure simplicity and seamless user experience.",
    stack: [
      {
        id: "icon-1",
        icon: SiReact,
  ...
  },
  {
    ...
    image: greentrust,
    content:
      "Simple Portfolio design. Created a personal portfolio to showcase projects and achievements in a visually engaging format. Developed a visually appealing and user‑friendly portfolio to effectively showcase professional expertise and creativity",
    stack: [
      {
        id: "icon-3",
        icon: SiJavascript,
  ...
  },
  {
    ...
    image: chargeswap,
    content:
      "E‑commerce Responsive HTML Template based on bootstrap framework v4.5. Developed a modern, responsive web template tailored for diverse applications, including e‑commerce and corporate use. Emphasized a clean, professional design to attract and retain user attention",
    stack: [
      {
        id: "icon-3",
        icon: SiJavascript,
  ...
  },
  {
    ...
    image: recruitment,
    content:
      "Project Includes four games: Puzzle, Snake, XO, and Memory game. Developed an interactive platform featuring four games: Puzzle, Snake, XO, and Memory Game, aimed at enhancing users’ logical thinking and memory skills. Designed interactive games to deliver an engaging and enjoyable experience, catering to users of all age groups.",
    stack: [
      {
        id: "icon-3",
        icon: SiJavascript,
...
export const aboutMe = {
  ...
  tagLine: `
`,
  intro: "Full‑Stack Developer with over 2 years of experience in building scalable web and mobile applications. Skilled in modern frameworks like React, Angular, and Node.js, focusing on responsive design and seamless user experiences."
}
